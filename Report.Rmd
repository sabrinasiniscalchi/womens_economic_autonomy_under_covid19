...
ggplot(df_participation_LA, aes(x = year, y = mean_participation_rate)) +  
  ...
  labs(title = "Gráfico 1: Tasa de participación por sexo (%), 2013-2022 \n América Latina (promedio ponderado)",
       x = "Año",
