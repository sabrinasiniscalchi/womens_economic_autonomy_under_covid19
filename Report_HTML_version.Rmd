...
El gráfico 1 ilustra la evolución de las tasas de participación en el mercado laboral de las mujeres entre 2012 y 2022, evidenciando cómo las mujeres han sido afectadas en sus trayectorias laborales por la pandemia. 
No obstante ello, el panorama de la participación laboral femenina en América Latina durante y después de la pandemia de COVID-19 revela una compleja variedad de realidades nacionales, cada una con sus propias dinámicas y desafíos. La diversidad de estas situaciones queda claramente ilustrada en el Gráfico 2 que se presenta a continuación, donde se evidencia que los países con las mayores caídas en la tasa de participación de las mujeres en el mercado laboral son precisamente aquellos donde, antes de la crisis, estas tasas eran más elevadas.
...
```{r unemployment, warning = FALSE, echo = FALSE,fig.height=9}
#CHART3
...
El gráfico 3 proporciona un análisis detallado de la tasa de desempleo abierto en varios países de América Latina desde 2012 hasta 2021, desglosando los datos por sexo y años de enseñanza. A lo largo de la década, se observa que las tasas de desempleo femenino generalmente superan a las de los hombres en la mayoría de los niveles educativos y países analizados. En particular, se nota una tendencia al aumento del desempleo femenino en 2020, evidenciando un impacto diferencial por género en el mercado laboral. Países como Colombia y Brasil muestran las tasas más altas de desempleo femenino, mientras que en países como Uruguay, la tasa de desempleo femenino experimenta un incremento notable durante los años de la pandemia, siendo el país donde las mujeres con menor formación sufrieron mayor incremento en la tasa de desempleo.

# Pobreza

El gráfico 4 presenta la población en situación de pobreza por país, segmentada por el clima educativo del hogar y el sexo entre los años 2012 y 2022. Se observa que la pobreza afecta de manera desproporcionada a las mujeres en la mayoría de los países, especialmente aquellas con menor nivel educativo. Durante los años de la pandemia de COVID-19, particularmente en 2020, se nota un aumento en la proporción de mujeres en situación de pobreza, lo que sugiere que la crisis sanitaria pudo haber exacerbado las desigualdades existentes. Este impacto es más notable en los hogares con niveles educativos de "0 a 5 años" y "6 a 11 años", lo cual indica que la pandemia afectó en mayor medida a los grupos con menor educación. En comparación, los hogares con "15 años y más" de educación muestran una resiliencia relativamente mayor ante la crisis económica derivada del COVID-19.
...
base_plot <- ggplot(df_poverty_by_sex_education_standarized,
  ...
  theme(plot.title = element_text(hjust = 0.5, size = 10),
        ...
        legend.title = element_text(size = 8, hjust = 0.5),
        legend.text = element_text(size = 6)) +
  labs(title = "Gráfico 4: Población en situación de pobreza por país según clima educativo del hogar y sexo 2012-2022",
       x = "Año",
...
El mapa 1 muestra una disminución en la participación de las mujeres en el mercado laboral entre los años 2019 y 2020 en varios países de América Latina, destacándose especialmente en la región andina, con tas de caída de la participacíon de las mujeres en el mercado laboral de más de 10% con respecto a sus niveles de 2019. 
...
El mapa 2 ilustra un incremento notable en la tasa de desempleo de las mujeres en algunos países de América Latina durante el periodo 2019-2020, destacando nuevamente el impacto sobre las poblaciones de Perú, Bolivia y Ecuador.
